...
const csvFiles = ['AffinityAuths.csv'];
...
const updateFirebaseRecords = (patient) => {
    ...
    const collectionRef = collection(db, 'BillingDetails'); // Replace with your collection name
...
const updateRecord = (docId, patient) => {
    const docRef = doc(db, 'BillingDetails', docId);
    updateDoc(docRef, {
